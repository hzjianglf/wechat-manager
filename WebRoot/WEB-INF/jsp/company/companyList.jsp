									...
									<tr>
										...
										<c:choose>
											<c:when test="${p.companyPic ne null && p.companyPic ne '' }">
												<td><img src="${pageContext.request.contextPath}/image/photo?imgName=${p.companyPic}" width="80px" height="60px"/></td>											
											</c:when>
											<c:otherwise>
												<td></td>
											</c:otherwise>
										...
										<td>
											<div class="am-dropdown" data-am-dropdown>
								                ...
								                <ul class="am-dropdown-content">
								                  ...
								                  <slp:privilege module="CompanyManager" oprator="update">
								                  	<li><a href="javascript:void(0)" name="${p.id}" class="bj">编辑</a></li>
								                  </slp:privilege>
								                  <slp:privilege module="CompanyManager" oprator="delete">
