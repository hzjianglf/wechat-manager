		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
      				<small>位置</small>：<small>消息管理中心</small>/<small>文本消息管理</small>
      			</div>
			</div>
			<form action="${pageContext.request.contextPath}/message/text/textMessageList" method="post" id="form1" class="am-form">
    		<div class="am-g">
    			<slp:privilege module="HrManager" oprator="add">
   				<div class="am-u-lg-2">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      <a href="${pageContext.request.contextPath}/message/text/addTextMessage"><span class="am-input-group-label">新增</span></a>
				    </div>
				 </div>
				 </slp:privilege>
   				<div class="am-u-lg-3">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      ...
				      <input type="text" name="keyword" placeholder="关键字" value="${textMessage.keyword}" class="am-form-field"/>
				    </div>
				 </div>
    		...
    		<form action="${pageContext.request.contextPath}/message/text/textMessageList" method="post" id="form2">
    			<input type="hidden" name="keyword" value="${textMessage.keyword}" />
										...
										<td>
											<div class="am-dropdown" data-am-dropdown>
								                ...
								                <ul class="am-dropdown-content">
								                  ...
								                  <slp:privilege module="TextMessageManager" oprator="update">
								                  	<li><a href="javascript:void(0)" name="${p.id}" class="bj">编辑</a></li>
								                  </slp:privilege>
								                  <slp:privilege module="TextMessageManager" oprator="delete">
		...
		*/
		...
		function del(id){
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/message/text/deleteTextMessage",
		...
		$(document).ready(function(){
			...
			$(".bj").click(function(){
				var id = $(this).attr("name");
				var url = "${pageContext.request.contextPath}/message/text/updateTextMessage?id=" + id;
				var cname = "${textMessage.keyword}";
