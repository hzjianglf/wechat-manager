    			...
    			<slp:privilege module="HrManager" oprator="add">
   				<div class="am-u-lg-2">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      <a href="${pageContext.request.contextPath}/article/addArticles"><span class="am-input-group-label">新增</span></a>
				    </div>
				 </div>
				 </slp:privilege>
   				<div class="am-u-lg-3">
	...
	<script type="text/javascript">
		...
		*/
		...
		$(document).ready(function(){
			...
			$(".bj").click(function(){
				var id = $(this).attr("name");
				var url = "${pageContext.request.contextPath}/article/updateArticle?id=" + id;
