		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
      				<small>位置</small>：<small>公司管理中心</small>/<small>历史沿革管理</small>
      			</div>
			</div>
			<form action="${pageContext.request.contextPath}/about_us/history/historyList" method="post" id="form1" class="am-form">
    		<div class="am-g">
    			<slp:privilege module="HistoryManager" oprator="add">
   				<div class="am-u-lg-2">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      <a href="${pageContext.request.contextPath}/about_us/history/addHistoryInfo"><span class="am-input-group-label">新增</span></a>
				    </div>
				 </div>
				 </slp:privilege>
   				<div class="am-u-lg-3">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      ...
				      <input type="text" name="historyName" placeholder="名称" value="" class="am-form-field"/>
				    </div>
				 </div>
    		...
    		<form action="${pageContext.request.contextPath}/about_us/history/historyList" method="post" id="form2">
    			<input type="hidden" name="historyName" value="" />
							...
							<tbody>
								<c:forEach items="${list }" var="p" varStatus="status">
									<tr>
										...
										<td><fmt:formatDate value="${p.historyYear}" pattern="yyyy"></fmt:formatDate></td>
										<td>${p.historyName}</td>
										<td>
										...
										<td>
											<div class="am-dropdown" data-am-dropdown>
								                ...
								                <ul class="am-dropdown-content">
								                  ...
								                  <slp:privilege module="HistoryManager" oprator="update">
								                  	<li><a href="javascript:void(0)" name="${p.id}" class="bj">编辑</a></li>
								                  </slp:privilege>
								                  <slp:privilege module="HistoryManager" oprator="delete">
		...
		*/
		...
		function del(id){
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/about_us/history/deleteHistoryInfo",
		...
		$(document).ready(function(){
			...
			$(".bj").click(function(){
				var id = $(this).attr("name");
				var url = "${pageContext.request.contextPath}/about_us/history/updateHistoryInfo?id=" + id;
