		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
      				<small>位置</small>：<small>服务管理中心</small>/<small>服务案例信息管理</small>
      			</div>
			</div>
			<form action="${pageContext.request.contextPath}/case/caseList" method="post" id="form1" class="am-form">
    		<div class="am-g">
    			<slp:privilege module="HrManager" oprator="add">
   				<div class="am-u-lg-2">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      <a href="${pageContext.request.contextPath}/case/addCaseInfo"><span class="am-input-group-label">新增</span></a>
				    </div>
				 </div>
				 </slp:privilege>
   				<div class="am-u-lg-3">
				    <div class="am-input-group am-input-group-secondary am-form-group">
				      ...
				      <input type="text" name="caseName" placeholder="名称" value="" class="am-form-field"/>
				    </div>
				 </div>
    		...
    		<form action="${pageContext.request.contextPath}/case/caseList" method="post" id="form2">
    			<input type="hidden" name="caseName" value="" />
										...
										<td>
											<div class="am-dropdown" data-am-dropdown>
								                ...
								                <ul class="am-dropdown-content">
								                  ...
								                  <slp:privilege module="CaseManager" oprator="update">
								                  	<li><a href="javascript:void(0)" name="${p.id}" class="bj">编辑</a></li>
								                  </slp:privilege>
								                  <slp:privilege module="CaseManager1" oprator="delete">
		...
		*/
		...
		function del(id){
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/case/deleteCaseInfo",
		...
		$(document).ready(function(){
			...
			$(".bj").click(function(){
				var id = $(this).attr("name");
				var url = "${pageContext.request.contextPath}/case/updateCaseInfo?id=" + id;
